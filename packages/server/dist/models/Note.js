...
let Note = (_dec = (0, _typeorm.Entity)('notes'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('uuid'), _dec3 = (0, _typeorm.Column)(), _dec4 = (0, _typeorm.Column)(), _dec5 = (0, _typeorm.Column)(), _dec6 = (0, _typeorm.ManyToOne)(() => _User.default), _dec7 = (0, _typeorm.JoinColumn)({
  name: 'user_id'
}), _dec8 = (0, _typeorm.CreateDateColumn)(), _dec9 = (0, _typeorm.UpdateDateColumn)(), _dec(_class = (_class2 = (_temp = class Note {
  constructor() {
  ...
  writable: true,
  initializer: null
}), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "user_id", [_dec5], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
